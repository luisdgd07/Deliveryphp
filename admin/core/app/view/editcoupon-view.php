...
<form class="form-horizontal" role="form" method="post" action="index.php?action=updatecoupon">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="text" class="form-control" name="val" value="<?php echo $coupon->val; ?>" placeholder="Valor del cupon en %">
    </div>
  </div>
  <div class="form-group">
...
<option value="<?php echo $cat->id; ?>" <?php if($cat->id==$coupon->product_id){ echo "selected";}?>><?php echo $cat->nombre; ?></option>
<?php endforeach; ?>
</select>
