...
<?php if(PaymethodData::getByName("paypal")['activo']):?> 
              <div class="panel panel-default">
                <div class="panel-heading">
...
<?php foreach($settings as $cat):?>
  <?php 
  if(substr($cat->nombre, 0,7)=="paypal_"):?>
                        <tr>
                        <td><?php echo $cat->label; ?>
                        </td>
                        <td>
                        <input type="text" name="<?php echo $cat->nombre; ?>" class="form-control" value="<?php echo $cat->val;?>">
                        </td>
                        </tr>
 <?php endif; ?>
<?php endforeach; ?>
 <?php endif; ?>
            ...
            <?php endif; ?>
<?php if(PaymethodData::getByName("mp")['activo']):?>
              <div class="panel panel-default">
                <div class="panel-heading">
...
<?php endforeach; ?>
 <?php endif; ?>
            ...
            <?php endif; ?>
<?php if(PaymethodData::getByName("bank")['activo']):?>
              <div class="panel panel-default">
                <div class="panel-heading">
...
<?php foreach($settings as $cat):?>
  <?php 
  if(substr($cat->nombre, 0,5)=="bank_"):?>
                        <tr>
                        <td><?php echo $cat->label; ?>
                        </td>
                        <td>
...
<?php if(PaymethodData::getByName("tigo")['activo']):?>
              <div class="panel panel-default">
                <div class="panel-heading">
                  <i class="fa fa-credit-card"></i> Tigo Money
                </div>
<form method="post" action="./?action=updatepmsettings">
                    <table class="table table-bordered">
                      <tbody>
...
<?php foreach($settings as $cat):?>
  <?php 
  if(substr($cat->nombre, 0,5)=="tigo_"):?>
                        <tr>
                        <td><?php echo $cat->label; ?>
                        </td>
                        <td>
