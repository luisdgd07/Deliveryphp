...
<input type="hidden" name="product_id" value="<?php echo $_GET["product_id"];?>">
  ...
  <div class="form-group">
    ...
    <div class="col-lg-10">
      <input type="text" required class="form-control" name="titulo" placeholder="Titulo de la Imagen">
    </div>
  </div>
...
<form class="form-horizontal" role="form" method="post" action="index.php?action=prodimgs&opt=upd">
  <div class="form-group">
    <label for="inputEmail1" class="col-lg-2 control-label">Titulo</label>
    <div class="col-lg-10">
      <input type="text" required class="form-control" name="titulo" value="<?php echo $cat->titulo;?>" placeholder="Titulo de la Imagen">
    </div>
  </div>
