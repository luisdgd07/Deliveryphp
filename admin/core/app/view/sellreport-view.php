            ...
            <div class="col-lg-12">
              <div class="panel panel-default">
                <div class="panel-heading">
                  <i class="fa fa-tasks"></i> Reporte de Pedidos
                </div>
...
?>
                        <tr>
                        <td><a href="index.php?view=openbuy&buy_id=<?php echo $b->id; ?>" class="btn btn-xs btn-primary">Detalles</a></td>
                        <td>#<?php echo $b->id; ?></td>
                        <td><?php echo $b->getClient()->getFullname(); ?></td>
    <td>Bs <?php echo number_format($b->getTotal(),2,".",","); ?></td>
  
    <td>Bs <?php echo number_format($b->getTotal()-$discount,2,".",","); ?></td>
