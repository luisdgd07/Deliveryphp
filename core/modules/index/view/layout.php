...
<?php foreach($cats as $cat):?>
          <li><a href="index.php?view=productos&cat=<?php echo $cat->detalle_cat; ?>"><?php echo $cat->nombre; ?></a></li>
<?php endforeach; ?>
        </ul>
      </li>
<?php endif; ?>
...
<div class="col-md-12">
<hr>
<p><b>ARSYSTEL BOLIVIA</b> &copy; 2018</p>
<ul class="list-inline">
<li><p class="text-muted">An <a href="http://evilnapsis.com/">Facebook</a> Production</p></li>
