...
@media(min-width: 700px){
 #div_maps {
  ...
  <!-- Modal -->
  <div class="modal fade" id="ubicacion" role="dialog">
...
<div style="display: ;" >
    Nueva Ubiv.<input type="text" id="coords" />
     <br>
     <br>
     Latitud <input class="xy" type="text" id="latitud" name="latitud" />
    <br>
    <br>
     Longitud <input class="xy" type="text" id="longitud" name="longitud" />
<br>
<br>
</div>
...
<br>
        ...
        <div class="modal-footer" stye="text-align: center !important;">
          ...
          <button  style=" border-radius: 6px !important; font-size: 16px; width:220px;"  type="button" name="confir_ubv" id="confir_ubv" onclick="addUbicacion(latitud.value,longitud.value,txtDir.value);confirmar.disabled=false;" class="btn btn-success btn-lg verde" data-dismiss="modal"  >ACEPTAR</button>
        </div>
   ...
   // navigator.geolocation.getCurrentPosition(viewMap,ViewError,{timeout:3000});
    ...
    switch(error.code) {
      ...
      coords =  {
          ...
          document.getElementById("latitud").value = '-17.3393462';
          document.getElementById("longitud").value =  '-63.2483747';
            setMapa(coords);  //pasamos las coordenadas al metodo para crear el mapa
...
var locApi="https://maps.googleapis.com/maps/api/geocode/json?latlng="+lat+","+long+"&sensor=true";
